...
<%
	...
	System.out.println("WP_out.jsp: " + sun + ", " + mon + ", " + tue + ", " + wed + ", " + thu + ", " + fri+ ", " + sat);
	
	schedule.put("sun", sun);
	schedule.put("mon", mon);
	schedule.put("tues", tue);
	schedule.put("wed", wed);
	schedule.put("thurs", thu);
	schedule.put("fri", fri);
	schedule.put("sat", sat);
	
	if(preference == null){
		System.out.println("invalid input");
		
		out.print("<script> alert('Invalid Input\\nPlease Try Again'); window.location = 'WorkoutPlan_Input.jsp';</script>");
	}
	else
	{
		
		WorkoutPlan w = new WorkoutPlan(preference, schedule);
		...
		//delete previous workout plan if plan already exists
		if(exists){
			boolean delete = wpdbhelp.deleteEntry(idC.getValue());
			if(delete){
				System.out.println("delete successful");
			}
			else { System.out.println("delete unsuccessful"); }
		}
		wpdbhelp.addEntry(idC.getValue(), w);
		System.out.println("valid input");
		
		//response.sendRedirect("WorkoutEntry_Search.jsp");
