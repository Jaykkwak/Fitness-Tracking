            ...
            <form action = "MealPlan_output.jsp" class="body-text">
                <table id="table1">
                    <tr>
                        ...
                        <input type="text" name="target-bmi" value="" required >
                        <br></th>
                    </tr>
                    <tr>
                        <th class="th1"> Target BMI </th>
                        <th><input type="text" name="calorie-intake" value="" required > <br></th>
                    </tr>
                </table>
                ...
                <table id="table2">
                    ...
                    <tr>
                        <th><input type="text" name="protein" value="" required > <br></th>
                        <th><input type="text" name="carbs" value="" required> <br></th>
                        <th><input type="text" name="fat" value="" required> <br></th>
                    </tr>
                </table>
