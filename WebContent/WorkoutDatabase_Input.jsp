...
<%@ page
	import="java.sql.*, java.util.*, java.util.Calendar, java.util.Date, java.text.SimpleDateFormat, EasyFit_Model.ExampleWorkout, EasyFit_Model.ExampleWorkoutDBHelper"%>
...
<body>
    ...
    <div class="main">
        ...
        <div class="main-body">
            <form action="WorkoutDatabase_Input.jsp" class="search-bar">
                <input type="text" name = "workoutdb-search-input" placeholder="Search by exercise or name">
                <button type="submit" id="search-btn" value="submit">Search</button>
            </form>
            <h1>Workouts</h1>
            <table class="workout-tb" id="workout-db-table">
                <tr id="header">
                    <th>Workout #</th>
                    <th>Name</th>
                    <th>Exercise</th>
                ...
                <%
                	...
                	String searchCrit = request.getParameter("workoutdb-search-input");
                	
                	//fresh page --> no search criteria 
                	if(searchCrit==null || searchCrit.equals("")){
                		System.out.println("WorkoutDB_In.jsp: no search");
                    	...
                    	for(ExampleWorkout w: workouts){
                    		...
                    		out.print("<tr class='rows' onclick='open_modal(this)'>");
                    		out.print("<td>"+row+"</td>");
                	...
                	//user searched
                		...
                		System.out.println("WorkoutDB_In.jsp: search = " + searchCrit);
                		
						ArrayList<ExampleWorkout> workouts = ewdbhelp.searchExampleWorkouts(searchCrit);
    ...
    <script>
        ...
        function open_modal(thisRow){
        	var table = document.getElementById("workout-db-table");
			var wName = table.rows[thisRow.rowIndex].cells[1].innerHTML;
            window.location="WorkoutDatabase_Output.jsp?workout-name="+wName;
        }
