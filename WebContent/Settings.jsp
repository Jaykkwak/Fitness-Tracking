...
<%@ page import="javax.servlet.http.Cookie, EasyFit_Model.FitnessGoal, EasyFit_Model.FitnessGoalDBHelper"%>
...
<body>
	...
	<%
		...
		FitnessGoal fg = fgdbhelp.getFG(idC.getValue());
		
		double currentBMI = fg.getCurrentBMI();
		double targetBMI = fg.getTargetBMI();
		int tframe = fg.getTimeFrame();
			...
			<div class="form-box">
				<form action="Settings_Password_Output.jsp">
					...
					<div class="password">
							...
							<button type="submit" class="button-pwd" role="button">Save</button>
					</div>
				</form>
				<br>
				<br>
				...
				<form action="Settings_FG_Output.jsp">
					...
					<div id="old-workout-header" class="workout-body">
						<h3 style="font-size: 30px">Fitness Goal </h3> 
						<h3 style="font-size: 20px">Current BMI:  </h3><%=currentBMI%>
						<h3 style="font-size: 20px">Target BMI:  </h3><%=targetBMI%>
						<h3 style="font-size: 20px">Time Frame:  </h3><%=tframe%>
					</div>
					<br>
					<div class="password">
							<label for="new-password"><h2>Current Height</h2></label> 
							<input type="text" class="input-field" name="settings-height" placeholder="in inches"><br>
							<label for="confirm-password"><h2>Current Weight</h2></label> 
							<input type="text" class="input-field" name="settings-weight" placeholder="in pounds">
							<label for="confirm-password"><h2>Goal Weight</h2></label> 
							<input type="text" class="input-field" name="settings-target-weight" placeholder="in pounds">
							<label for="confirm-password"><h2>Time Frame</h2></label> 
							<input type="text" class="input-field" name="settings-tframe" placeholder="in months">
							<button type="submit" class="button-fg" role="button">Save</button>
					</div>
				</form>
