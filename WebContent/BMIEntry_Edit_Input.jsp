...
<title>BMI Entry Edit Input</title>
</head>
<body>
	<!-- navbar -->
	<nav class="navbar">
	...
	<div class="main">
		...
		<%
			...
			System.out.println("BMI_Edit_Input: received: " + num);
			String date = request.getParameter("date");
			System.out.println("BMI_Edit_Input: received: " + date);
			String bmi = request.getParameter("bmi");
			System.out.println("BMI_Edit_Input: received: " + bmi);
			String userID = request.getParameter("userID");
			System.out.println("BMI_Edit_Input: received: " + userID);
			String bmiLogID = request.getParameter("bmiLogID");
			System.out.println("BMI_Edit_Input: received: " + bmiLogID);
		%>
		<div class="main-body">
			<form action="BMIEntry_Edit_Output.jsp" class="body-text">
			
				<input type="hidden" name="bmi-edit-bmiLogID" value="<%=bmiLogID%>">
				<input type="hidden" name="bmi-edit-date" value="<%=date%>">
				<input type="hidden" name="bmi-edit-num" value="<%=num%>">
				<input type="hidden" name="bmi-edit-bmi" value="<%=bmi%>">
				...
				<table id="table1">
					<tr>
						...
						<th><input type="text" name="height-input" required> <br></th>
					</tr>
					<tr>
						<th class="th1">New Weight
							<div id="unit">(in pounds)</div>
						</th>
						<th><input type="text" name="weight-input" required>
							<br></th>
					</tr>
				</table>
