...
<!-- navbar -->
	<nav class="navbar">
		<div class="nav-container">
			...
			<ul class="nav-menu">
				<li><a href="#signout" class="nav-links nav-btn" onClick="signin()">Sign In</a></li>
			</ul>
		</div>
	</nav>
	...
	<script>
		function signin(){
			window.location="SigninRegister.jsp";
		}
	</script> 
	...
	<div class="hero" id="home" class="">
		<div class="hero_container">
			<div class="hero_text">
				...
				<a class="main_btn" href="SigninRegister.jsp">Get Started</a>
			</div>
			<div class="hero_img">
