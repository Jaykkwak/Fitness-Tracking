...
<body>
	<%
		...
		if (height < 0 || weight < 0 || sHeight == null || sWeight == null) {
			...
			bdbhelp.addEntry(idC.getValue(), b);
		}
	%>
	...
	<div class="main">
		...
		<div class="main-body">
			<form class="body-text">
				<span class="bmi-body"> BMI LOG #number </span>
				<%
				...
				<table id="table1">
					<tr>
						...
						<th><input type="text" name="height-input" value="">
							<br></th>
					</tr>
					<tr>
						<th class="th1">Weight
						...
						<th><input type="text" name="weight-input" value="">
							<br></th>
					</tr>
				</table>
